...
// 1, such as 2 and 5. Any number can be written as a product of prime numbers in
// a unique way (except for the order). These are called prime factors of a
